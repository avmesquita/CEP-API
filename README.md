...
<p>
  <ul>
    <li>node.CEP</li>    
    <li><a href="https://github.com/avmesquita/CEP-API-node">Project</a></li>
...
Licensed under the [GNU General Public License v3.0](https://github.com/avmesquita/CEP-API/blob/master/LICENSE)
